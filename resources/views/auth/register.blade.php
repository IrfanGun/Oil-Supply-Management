<x-guest-layout  >
    ...
    <div class="container mx-auto px-4 md:w-1/2 items-center justify-center">
        <div class=" md:grid-cols-2 gap-20 relative items-center justify-center ">
          ...
          <div class="font-poppins z-10 bg-white rounded-md inset-y-0 right-0 mx-10 my-10 p-8 w-auto h-auto border-b-gray-300">
            ...
            <form class="text-sm mt-8"  x-data= "{ submittedForm: false }" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                ...
                <div class="flex-col mt-10">
                    ...
                    <p class="text-center mt-2">Sudah memiliki akun ? <span class="cursor-pointer" ><a href="{{ route('login') }}"> Masuk</a></span></p>
