<div class="bg-white rounded-lg font-poppins p-3 overflow-hidden 
" >
    ...
    <div x-data="{ selectedUserId: @entangle('selectedUserId')} " >
       <div x-data="{open : false}">
        <div class="flex  ">
            ...
            <Span class="m-auto text-sm">Percakapan</Span>
            ...
            <div class=" grid grid-cols-2 duration-500 rounded-lg ease-in-out w-[452px] h-[270px] " :class = "{'-translate-x-1/2'  : open} ">
                <div class=" p-2 top-0  left-0  overflow-y-scroll scrollbar-hide" >
                    ...
                    <div class="flex-col ">
                        ...
                        <button wire:click = "selectUser({{$user->id}})" @click = "open = ! open" class="flex py-2 hover:bg-[#f4f4f6] rounded-full w-full">
                            <img class="rounded-full ml-2 " src="{{ Storage::url($user->avatar) }}" alt="" height="auto" width="30px">
                            <div class="ml-2">
                ...
                <div class="relative h-[270px] ">
                    ...
                    @else
                    <p class="text-center text-[10px]">Mulai membuka percakapan</p>
                    @endif
...
@endrole
    ...
    @role('pelanggan')
    <span class="m-auto">Percakapan</span>
    <livewire:message :userId=1 />
    @endrole
