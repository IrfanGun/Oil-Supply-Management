<div class="bg-white rounded-xl font-poppins w-70 h-60 text-charleston-green p-3  ">
...
<script>
    ...
    const updateCalendar = () => {
        ...
        for(let i = 1; i <= 7 - lastDayInd ; i++) {
            ...
            datesInd += `<li class="aspect-square m-auto p-1 text-grey-100" >${nextDates.getDate()}</li>`;
        }
